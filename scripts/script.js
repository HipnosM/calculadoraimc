...
form.addEventListener('submit', function(event) {
    ...
    if(imc < 18.5) {
        ...
        description = 'Status: você está no peso ideal!';
        value.classList.remove('warning', 'medium', 'high');
        value.classList.add('normal');
    }
    else if(imc >25 && imc <= 30) {
        description = 'Status: cuidado, você está ficando acima do peso!';
        ...
        description ='Status: cuidado, você está com obesidade severa!'
    }
    else {
        description ='Status: cuidado, você está com obesidade mórbida!'
    }
